...
p2 <- tou[prices, .(RIN, RateName, RateType, DateStart, TimeStart, Day, Value, Unit), on = .(RIN = RIN, DateStart <= DateStart, DateEnd >= DateStart, DayStart <= Day, DayEnd >= Day, TimeStart <= TimeStart, TimeEnd >= TimeStart)]
